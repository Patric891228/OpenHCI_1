...
public class LLM : MonoBehaviour
{
    ...
    private string prompt = "你是一場報告的觀眾，請針對演講者說出的内容，提供我4個一個不認識香港的觀眾可能會問的問題，第二題是第一題的延伸，第四題是第三題的延伸，然後針對此講稿5份不同做出100字的回饋，關於内容是否切题，主題内容可以優化改進的地方。請你依照以下格式回答我，問題：1.<question>,2.<question>,3.<question>,4.<question>，回饋：1.<response>,2.<question>,3.<question>,4.<question>\n 請你把内容取代<question>,<response>，請在每個内容中間以空格為間隔。以下是演講逐字稿：";
