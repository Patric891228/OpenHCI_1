...
public class LLM : MonoBehaviour
{
    ...
    private string prompt = "你是一場報告的觀众，請針對演講者說出的内容，提供我4個講稿没有提到且方向跟演講内容不同但观众可能會問的問題，并針對此講稿5份不同做出100字的回饋，關於内容是否切题，主題内容可以優化改進的地方。請你依照以下格式回答我，问题：1.<question>,2.<question>,3.<question>,4.<question>，回饋：1.<response>,2.<question>,3.<question>,4.<question>,5.<question>\n 請你把内容取代<question>,<response>，請在每個内容中間以空格為間隔。以下是演讲逐字稿：";
